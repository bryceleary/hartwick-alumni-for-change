...
"WickAdmits" <- read.csv("C:/Users/melut/Desktop/hartwick-alumni-for-change/data/Data_6-27-2020.csv", header=TRUE)
...
"WickAdmits4" <- WickAdmits3 %>% rename("TotalAdmits_2014" = Admissions.total..ADM2014_RV.,
                                        ...
                                        "AmericanIndian_2000" = American.Indian.Alaska.Native.total..EF2000A..All.students..Undergraduate.total.,
                                        "AmericanIndian_2001" = American.Indian.Alaska.Native.total..EF2001A..All.students..Undergraduate.total.,
                                        "AmericanIndian_2002" = American.Indian.Alaska.Native.total..EF2002A..All.students..Undergraduate.total.,
                                        "AmericanIndian_2003" = American.Indian.or.Alaska.Native.total..EF2003A..All.students..Undergraduate.total.,
                                        "AmericanIndian_2004" = American.Indian.or.Alaska.Native.total..EF2004A_RV..All.students..Undergraduate.total.,
                                        ...
                                        "AmericanIndian_2013" = American.Indian.or.Alaska.Native.total..EF2013A_RV..All.students..Undergraduate.total.,
                                        "AmericanIndian_2014" = American.Indian.or.Alaska.Native.total..EF2014A_RV..All.students..Undergraduate.total.,
                                        "AmericanIndian_2015" = American.Indian.or.Alaska.Native.total..EF2015A_RV..All.students..Undergraduate.total.,
                                        "AmericanIndian_2016" = American.Indian.or.Alaska.Native.total..EF2016A_RV..All.students..Undergraduate.total.,
                                        "AmericanIndian_2017" = American.Indian.or.Alaska.Native.total..EF2017A_RV..All.students..Undergraduate.total.,
                                        "AmericanIndian_2018" = American.Indian.or.Alaska.Native.total..EF2018A..All.students..Undergraduate.total.,
...
#Shift into time series format
"data2018" <- select(wickdata, contains("2018"))
data2018 <- mutate(data2018, "year" = 2018)
data2018 <- rename_all(data2018, funs(str_replace(., "_2018", "")))

"data2017" <- select(wickdata, contains("2017"))
data2017 <- mutate(data2017, "year" = 2017)
data2017 <- rename_all(data2017, funs(str_replace(., "_2017", "")))

"data2016" <- select(wickdata, contains("2016"))
data2016 <- mutate(data2016, "year" = 2016)
data2016 <- rename_all(data2016, funs(str_replace(., "_2016", "")))

"data2015" <- select(wickdata, contains("2015"))
data2015 <- mutate(data2015, "year" = 2015)
data2015 <- rename_all(data2015, funs(str_replace(., "_2015", "")))

"data2014" <- select(wickdata, contains("2014"))
data2014 <- mutate(data2014, "year" = 2014)
data2014 <- rename_all(data2014, funs(str_replace(., "_2014", "")))

"data2013" <- select(wickdata, contains("2013"))
data2013 <- mutate(data2013, "year" = 2013)
data2013 <- rename_all(data2013, funs(str_replace(., "_2013", "")))

"data2012" <- select(wickdata, contains("2012"))
data2012 <- mutate(data2012, "year" = 2012)
data2012 <- rename_all(data2012, funs(str_replace(., "_2012", "")))

"data2011" <- select(wickdata, contains("2011"))
data2011 <- mutate(data2011, "year" = 2011)
data2011 <- rename_all(data2011, funs(str_replace(., "_2011", "")))

"data2010" <- select(wickdata, contains("2010"))
data2010 <- mutate(data2010, "year" = 2010)
data2010 <- rename_all(data2010, funs(str_replace(., "_2010", "")))

"data2009" <- select(wickdata, contains("2009"))
data2009 <- mutate(data2009, "year" = 2009)
data2009 <- rename_all(data2009, funs(str_replace(., "_2009", "")))

"data2008" <- select(wickdata, contains("2008"))
data2008 <- mutate(data2008, "year" = 2008)
data2008 <- rename_all(data2008, funs(str_replace(., "_2008", "")))

"data2007" <- select(wickdata, contains("2007"))
data2007 <- mutate(data2007, "year" = 2007)
data2007 <- rename_all(data2007, funs(str_replace(., "_2007", "")))
data2007 <- mutate(data2007, "TwoOrMore" = NA)
data2007 <- mutate(data2007, "HawaiianPacificIslander" = NA)

"data2006" <- select(wickdata, contains("2006"))
data2006 <- mutate(data2006, "year" = 2006)
data2006 <- rename_all(data2006, funs(str_replace(., "_2006", "")))
data2006 <- mutate(data2006, "TwoOrMore" = NA)
data2006 <- mutate(data2006, "HawaiianPacificIslander" = NA)

"data2005" <- select(wickdata, contains("2005"))
data2005 <- mutate(data2005, "year" = 2005)
data2005 <- rename_all(data2005, funs(str_replace(., "_2005", "")))
data2005 <- mutate(data2005, "TwoOrMore" = NA)
data2005 <- mutate(data2005, "HawaiianPacificIslander" = NA)

"data2004" <- select(wickdata, contains("2004"))
data2004 <- mutate(data2004, "year" = 2004)
data2004 <- rename_all(data2004, funs(str_replace(., "_2004", "")))
data2004 <- mutate(data2004, "TwoOrMore" = NA)
data2004 <- mutate(data2004, "HawaiianPacificIslander" = NA)

"data2003" <- select(wickdata, contains("2003"))
data2003 <- mutate(data2003, "year" = 2003)
data2003 <- rename_all(data2003, funs(str_replace(., "_2003", "")))
data2003 <- mutate(data2003, "TwoOrMore" = NA)
data2003 <- mutate(data2003, "HawaiianPacificIslander" = NA)

"data2002" <- select(wickdata, contains("2002"))
data2002 <- mutate(data2002, "year" = 2002)
data2002 <- rename_all(data2002, funs(str_replace(., "_2002", "")))
data2002 <- mutate(data2002, "TwoOrMore" = NA)
data2002 <- mutate(data2002, "HawaiianPacificIslander" = NA)

"data2001" <- select(wickdata, contains("2001"))
data2001 <- mutate(data2001, "year" = 2001)
data2001 <- rename_all(data2001, funs(str_replace(., "_2001", "")))
data2001 <- mutate(data2001, "TwoOrMore" = NA)
data2001 <- mutate(data2001, "HawaiianPacificIslander" = NA)

"data2000" <- select(wickdata, contains("2000"))
data2000 <- mutate(data2000, "year" = 2000)
data2000 <- rename_all(data2000, funs(str_replace(., "_2000", "")))
data2000 <- mutate(data2000, "TwoOrMore" = NA)
data2000 <- mutate(data2000, "Apps" = NA)
data2000 <- mutate(data2000, "TotalAdmits" = NA)
data2000 <- mutate(data2000, "Enrolled" = NA)
data2000 <- mutate(data2000, "HawaiianPacificIslander" = NA)

finalwickdata <- rbind(data2000, data2001, data2002, data2003, data2004, data2005, data2006, data2007, data2008,
                       data2009, data2010, data2011, data2012, data2013, data2014, data2015, data2016, data2017, data2018)

finalwickdata <- finalwickdata[, c(9, 11, 12, 13, 1, 2, 3, 4, 5, 6, 7, 14, 10, 8)]
...
"wick10_18" <- subset(finalwickdata, year >=2010)