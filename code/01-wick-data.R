...
ggplot(data=finalwickdata, mapping = aes(x = year)) +
  ...
  geom_line(aes(y = AmericanIndianAlaskaNative, color = "American Indian & Alaska Native")) +
...
finalwickdata <- mutate(finalwickdata, "AmrIndianAlaNativePer" = AmericanIndianAlaskaNative/TotalUndergrad * 100)
...
ggplot(data=finalwickdata, mapping = aes(x = year)) +
  ...
  geom_line(aes(y = AmrIndianAlaNativePer, color = "American Indian & Alaska Native")) +
