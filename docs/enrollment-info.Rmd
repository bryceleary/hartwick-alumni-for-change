---
title: "Hartwick College Enrollment Data"
author: "Bryce Leary"
date: "7/5/2020"
output: pdf_document
---
...
### Examining Enrollment Data at Harwick COllege ###
```{r importclean, include=FALSE, warning = FALSE}
###Set-Up
library(tidyverse)
library(here)
...
#Hartwick Undergraduate Enrollment in total numbers

Derp derp derp

```{r undergrad, echo=FALSE, warning = FALSE}
...
ggplot(data=wick10_18, mapping = aes(x = year)) +
  ...
  theme(legend.position = "right")
```
#Hartwick Undergraduate Enrollment as Percent of Undergraduates
Derp derp derp
